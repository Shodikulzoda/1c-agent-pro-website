  ...
  steps: [
    {
      ...
      duration: "5 минут",
      description:
        "Агент загружает актуальные данные: клиенты, товары, цены, задания и остатки. Работает даже при нестабильном интернете.",
    },
    {
      icon: "route",
      title: "Маршрут",
      duration: "10 минут",
      description:
        "Оптимальный план визитов на день с учётом геолокации. Меньше времени в дороге — больше клиентов.",
    },
    {
      icon: "map-pin",
      title: "Визит к клиенту",
      duration: "15 минут",
      description: "Карточка клиента: история заказов, задолженности, контакты — всё под рукой перед разговором.",
    },
    {
      icon: "shopping-cart",
      ...
      duration: "3 минуты",
      description:
        "Быстрый подбор товаров из каталога с актуальными ценами и остатками. Заказ готов за минуты.",
    },
    {
      icon: "camera",
      title: "Фотоотчёт",
      duration: "2 минуты",
      description:
        "Фото торговой точки и выкладки — подтверждение визита, контроль мерчендайзинга.",
    },
    {
      icon: "check-circle-2",
      ...
      description:
        "Все заказы, фото и данные визитов синхронизируются в 1С в реальном времени.",
    },
  ],
} as const;
...
export const managerControl = {
  ...
  points: [
    ...
    {
      icon: "navigation",
      title: "Посещения и визиты",
      description: "История визитов по каждому клиенту с фактическим временем",
    },
    {
      icon: "camera",
      title: "Фотоотчёты",
      description: "Фотографии торговых точек и выкладки по каждому визиту",
    },
    {
      icon: "check-circle-2",
      title: "Выполнение заданий",
      description: "Контроль выполнения заданий и плановых показателей агентами",
    },
  ],
  dashboard: {
...
export const pricing = {
  ...
  benefits: [
    { icon: "check-circle-2", label: "Оплата по факту" },
    { icon: "trending-up", label: "Гибкая шкала цен" },
    { icon: "graduation-cap", label: "Внедрение и обучение входят" },
    { icon: "headphones", label: "Поддержка всегда на связи" },
  ],
  tiers: [
    {
      tag: "Standard",
...
export const implementation = {
  eyebrow: "Внедрение и поддержка",
  title: "Мы не просто даём программу — мы помогаем внедрить",
  steps: [
    {
      icon: "blocks",
      title: "Установим",
      description: "Настроим соединение с вашей 1С — без лишних хлопот.",
    },
    {
      icon: "settings",
      title: "Настроим",
      description: "Параметры системы под ваш бизнес и команду.",
    },
    {
      icon: "graduation-cap",
      title: "Обучим",
      description: "Агентов и руководителей работе в системе.",
    },
    {
      icon: "headphones",
      title: "Поддерживаем",
      description: "На связи в рабочее время — быстро отвечаем на вопросы.",
    },
    {
      icon: "trending-up",
      title: "Развиваем",
      description: "Обновления и доработки включены в подписку.",
    },
  ],
  stats: [
    { value: "до 2 дней", label: "Среднее время внедрения" },
    { value: "1 день", label: "Обучение команды" },
    { value: "1 час", label: "Время реакции поддержки" },
...
export const valueProps = {
  trial: {
    eyebrow: "Попробуйте бесплатно",
    title: "15 дней без оплаты",
    description:
      "Полный доступ ко всем функциям выбранного тарифа. Никаких скрытых условий — просто попробуйте и убедитесь сами.",
    badge: "Бесплатный период",
    cta: "Начать бесплатно",
    note: "Карта не требуется. Отмена в любой момент.",
  },
  cloud: {
    eyebrow: "Без своего сервера",
    title: "Бесплатная облачная подписка",
    description:
      "Серверный модуль работает в нашем защищённом облаке — без затрат на сервер и администрирование. Облачная инфраструктура включена в стоимость тарифа.",
    badge: "Облако включено",
  },
} as const;
...
export const downloadPage = {
  ...
  serverModule: {
    ...
    configs: [
      { id: "ut115", name: "Управление торговлей 11.5", short: "УТ 11.5", fileUrl: null as string | null, fileName: "1C_AgentPro_UT115.epf" },
      { id: "ka25", name: "Комплексная автоматизация 2.5", short: "КА 2.5", fileUrl: null as string | null, fileName: "1C_AgentPro_KA25.epf" },
      { id: "erp25", name: "ERP Управление предприятием 2.5", short: "ERP 2.5", fileUrl: null as string | null, fileName: "1C_AgentPro_ERP25.epf" },
      { id: "unf30", name: "Управление нашей фирмой 3.0", short: "УНФ 3.0", fileUrl: null as string | null, fileName: "1C_AgentPro_UNF30.epf" },
      { id: "retail30", name: "Розница 3.0", short: "Розница 3.0", fileUrl: null as string | null, fileName: "1C_AgentPro_Retail30.epf" },
      { id: "buh-tj30", name: "Бухгалтерия для Таджикистана 3.0", short: "Бухгалтерия ТЖ 3.0", fileUrl: null as string | null, fileName: "1C_AgentPro_BuhTJ30.epf" },
    ],
  },
};
  ...
  fields: {
    ...
    config: {
      ...
      options: [
        ...
        "Розница 3.0",
        "Бухгалтерия для Таджикистана 3.0",
        "Другая конфигурация",
      ],
    },

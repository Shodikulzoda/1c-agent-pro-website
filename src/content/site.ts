...
export const industries = {
  ...
  title: "Кому подойдёт 1C Agent Pro",
  description: "Система заточена под задачи полевых продаж — не универсальная ERP и не CRM общего назначения.",
  notFor: "Не подходит для розничных магазинов, складов без выездных агентов и офисных продаж.",
  items: [
    {
      icon: "truck",
      title: "Дистрибьюторы",

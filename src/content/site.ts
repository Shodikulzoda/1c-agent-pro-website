...
export const valueProps = {
  ...
  cloud: {
    ...
    sections: [
      {
        heading: "Безопасный обмен без статического IP",
        body: "1C Agent Pro обеспечивает обмен данными между 1С и мобильными устройствами агентов без необходимости подключения статического IP-адреса. Данные передаются по зашифрованному соединению.",
      },
      {
        heading: "Балансировка нагрузки и масштабирование",
        body: "Распределение нагрузки и параллельная обработка запросов агентов в 1С позволяют масштабировать 1C Agent Pro по мере роста компании, количества сотрудников и объёма передаваемых данных.",
      },
    ],
  },
} as const;
...
export const demoForm = {
  ...
  fields: {
    ...
    config: {
      ...
      options: [
        "1С Управление торговлей 11.5 и новее",
        "1С Комплексная автоматизация 2.5 и новее",
        "1С:ERP Управление предприятием 2.5 и новее",
        "1С Управление нашей фирмой 3.0 и новее",
        "1С Розница 3.0 и новее",
        "1С Бухгалтерия для Таджикистана 3.0 и новее",
        "Другая конфигурация",
      ],
    },

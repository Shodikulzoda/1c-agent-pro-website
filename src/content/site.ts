...
export const valueProps = {
  ...
  cloud: {
    ...
    description:
      "Серверный модуль разворачивается в нашем защищённом облаке — не нужен собственный сервер, статический IP или системный администратор. Всё включено в стоимость тарифа.",

...
const TELEGRAM_USERNAME = "YunusovDavron";

/** Expandable floating contact button — click to reveal WhatsApp + Telegram. */
  ...
  return (
    ...
    >
      ...
      <button
        ...
        aria-expanded={open}
        className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl shadow-[#25D366]/40 transition-all duration-200 hover:scale-105"
      >
        {open ? (
          ...
          <svg viewBox="0 0 24 24" className="h-7 w-7 fill-none stroke-white stroke-[1.8]" aria-hidden="true">

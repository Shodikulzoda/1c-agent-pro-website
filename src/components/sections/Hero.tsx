    ...
    >
      ...
      <Container className="relative grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14">
        ...
        <div>
          ...
          <p
            className="text-ink-soft enter mt-4 max-w-lg text-base leading-relaxed sm:text-lg"
        ...
        <div className="relative hidden lg:block">
          <p
            className="script enter absolute -top-2 right-2 z-10 max-w-[13rem] rotate-[-6deg] text-right text-2xl"
          ...
          >
            <div
              aria-hidden
              className="border-line bg-surface shadow-brand-navy/15 text-heading absolute -top-4 -left-6 z-10 flex items-center gap-2 rounded-2xl border px-3.5 py-2.5 text-xs font-bold shadow-xl"
            >
            ...
            <div
              aria-hidden
              className="border-line bg-surface shadow-brand-navy/15 text-brand-green absolute -right-4 -bottom-4 z-10 rounded-2xl border px-3.5 py-2.5 text-xs font-bold shadow-xl"
            >
              {hero.floatingBadges.growth}
            </div>

            <div className="border-line bg-surface shadow-brand-navy/20 rounded-[34px] border p-3.5 shadow-2xl">
              <div className="bg-surface-tint flex min-h-[400px] flex-col gap-4 rounded-[22px] p-4">
